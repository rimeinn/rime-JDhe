...
请自行探索，如：也o 及je  得p 能f 诸如此类

#### 简词（可记可不记，全码都能打出）

二码简词的排序都是有意为之的，发现它的规律去适应他。

简词要对应，按词频排列没有意义，比如 vg 这个 ng那个 ，vl这里 nl那里，它们都是在次选，固定对应的位置，能更好的记住它们

#### 容错

简单鹤有贴心的容错，有时虽然你拆字的字根和推荐用法不一样，但你以为的拆法也许是大家以为的，所以当一个字，你发现这样能打出，那样也能打出。
